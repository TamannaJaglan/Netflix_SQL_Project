...
select 
unnest(string_to_array (country, ',')) as new_country --here we are using unnest and string_to_array to separate the countries by comma
from netflix
...
-- To Understand SPLIT_PART
-- For example: 
-- Select 
-- Split_part('Apple Bnana Carrot', ' ', 1);
